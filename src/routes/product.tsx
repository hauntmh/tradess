        ...
        <div className="flex flex-col justify-center">
          ...
          <div className="mt-6 flex flex-col sm:flex-row gap-3">
            <a
              ...
              className="w-full rounded-lg border border-[#F5E6C8]/30 bg-[#F5E6C8]/20 py-4 text-sm font-semibold uppercase tracking-[0.18em] text-[#F5E6C8] backdrop-blur-md transition hover:bg-[#F5E6C8]/30 sm:px-10 inline-block text-center"
            >
              Buy
            </a>
